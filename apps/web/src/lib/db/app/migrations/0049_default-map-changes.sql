...
DROP INDEX "idx_api_keys_user_id";--> statement-breakpoint
...
DROP INDEX "idx_light_scene_id";--> statement-breakpoint
...
CREATE INDEX `idx_light_scene_id` ON `light` (`scene_id`);--> statement-breakpoint
...
ALTER TABLE `scene` ALTER COLUMN "fog_of_war_opacity_dm" TO "fog_of_war_opacity_dm" real NOT NULL DEFAULT 0.75;--> statement-breakpoint
ALTER TABLE `scene` ALTER COLUMN "grid_opacity" TO "grid_opacity" real NOT NULL DEFAULT 0.25;--> statement-breakpoint
ALTER TABLE `scene` ALTER COLUMN "grid_line_color" TO "grid_line_color" text NOT NULL DEFAULT '#000000';