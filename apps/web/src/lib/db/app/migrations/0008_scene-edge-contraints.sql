...
INSERT INTO `__new_scene`("id", "session_id", "name", "order", "background_color", "display_padding_x", "display_padding_y", "display_size_x", "display_size_y", "display_resolution_x", "display_resolution_y", "fog_of_war_url", "fog_of_war_color", "fog_of_war_opacity", "map_location", "map_rotation", "map_offset_x", "map_offset_y", "map_zoom", "grid_type", "grid_spacing", "grid_opacity", "grid_line_color", "grid_line_thickness", "grid_shadow_color", "grid_shadow_spread", "grid_shadow_blur", "grid_shadow_opacity", "scene_offset_x", "scene_offset_y", "scene_rotation", "weather_fov", "weather_intensity", "weather_opacity", "weather_type", "fog_enabled", "fog_color", "fog_opacity", "edge_enabled", "edge_url", "edge_opacity", "edge_scale", "edge_fade_start", "edge_fade_end") SELECT "id", "session_id", "name", "order", "background_color", "display_padding_x", "display_padding_y", "display_size_x", "display_size_y", "display_resolution_x", "display_resolution_y", "fog_of_war_url", "fog_of_war_color", "fog_of_war_opacity", "map_location", "map_rotation", "map_offset_x", "map_offset_y", "map_zoom", "grid_type", "grid_spacing", "grid_opacity", "grid_line_color", "grid_line_thickness", "grid_shadow_color", "grid_shadow_spread", "grid_shadow_blur", "grid_shadow_opacity", "scene_offset_x", "scene_offset_y", "scene_rotation", "weather_fov", "weather_intensity", "weather_opacity", "weather_type", "fog_enabled", "fog_color", "fog_opacity", "edge_enabled", "edge_url", "edge_opacity", "edge_scale", "edge_fade_start", "edge_fade_end" FROM `scene`;--> statement-breakpoint
