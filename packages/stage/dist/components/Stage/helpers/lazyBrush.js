...
export class LazyBrushManager {
    constructor(config = {}) {
        ...
        this.lazyBrush = new LazyBrush({
            radius: (_a = config.radius) !== null && _a !== void 0 ? _a : 15, // Default radius for smoothing
            enabled: (_b = config.enabled) !== null && _b !== void 0 ? _b : true,
            initialPoint: (_c = config.initialPoint) !== null && _c !== void 0 ? _c : { x: 0, y: 0 }
        });
        this.isEnabled = (_d = config.enabled) !== null && _d !== void 0 ? _d : true;
        this.friction = (_e = config.friction) !== null && _e !== void 0 ? _e : 0.5; // Default friction for moderate smoothing
    }
    /**
